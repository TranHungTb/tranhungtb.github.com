...
unsigned char quetphim()
{
            ...
            {
                        PORTA=~(0x01<<(3+c));                        // Lan luot keo cac cot xuong muc logic 0
                        delay_ms(1);
                        for(r=0;r<4;r++)                              // Kiem tra cac hang
                        {
                                    if((PINA&(0x01<<(r)))==0)        // Neu hang nao co muc logic 0
                                    {
                                       // Cho den khi nut bam duoc tha ra
                                    return ((r*4)+c);                  // Tra ve ma phim da duoc bam
                                    }
                        }
            }
            }
...
// Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out   dao lai. sai
