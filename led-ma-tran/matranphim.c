...
int Key, i;
//unsigned char maled
//unsigned char maled[8]={0xEE,0xD4,0xBE};
unsigned char maled[8]={0x18,0x3C,0x66,0x66,0x7E,0x7E,0x66,0x66};
unsigned char maquet[8]={0xFE,0xFD,0xFB,0xF7,0xEF,0xDF,0xBF,0x7F};
...
//        }
	 ...
	 for(i=0;i<8;i++)
	 {
     PORTD = 0xFF; //tat toan bo LED
	 PORTB = maled[i];  //xuat ma led dong i
	 PORTD = maquet[i]; //bat sang dong i
	 delay_ms(1);
	 //---------Hien thi xong dong thu 1--------//
	  }
